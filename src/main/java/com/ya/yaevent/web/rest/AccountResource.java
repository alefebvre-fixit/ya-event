...
import com.ya.yaevent.web.rest.dto.KeyAndPasswordDTO;
...
public class AccountResource {
	...
	public ResponseEntity<?> registerAccount(@Valid @RequestBody UserDTO userDTO, HttpServletRequest request) {
		return userRepository.findOneByUsername(userDTO.getUsername())
				.map(user -> new ResponseEntity<>("username already in use", HttpStatus.BAD_REQUEST))
	...
	public ResponseEntity<String> saveAccount(@RequestBody UserDTO userDTO) {
		...
		return userRepository.findOneByUsername(SecurityUtils.getCurrentUser().getUsername()).map(u -> {
			userService.updateUserInformation(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
					userDTO.getCity(), userDTO.getCountry(), userDTO.getWebsite(), userDTO.getBiography(),
					userDTO.getLangKey());
