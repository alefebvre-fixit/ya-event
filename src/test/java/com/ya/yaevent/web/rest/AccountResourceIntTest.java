...
import com.ya.yaevent.web.rest.dto.UserDTO;
...
public class AccountResourceIntTest {
	...
	public void testRegisterDuplicateLogin() throws Exception {
		...
		UserDTO dup = new UserDTO(u.getUsername(), u.getPassword(), u.getUsername(), u.getLastName(),
				"alicejr@example.com", u.getCity(), u.getCountry(), u.getWebsite(), u.getBiography(), true,
	...
	public void testRegisterDuplicateEmail() throws Exception {
		...
		UserDTO dup = new UserDTO("johnjr", u.getPassword(), u.getUsername(), u.getLastName(), u.getEmail(),
				u.getCity(), u.getCountry(), u.getWebsite(), u.getBiography(), true, u.getLangKey(),
				u.getAuthorities());
